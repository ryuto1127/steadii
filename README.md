...
Live at [mysteadii.xyz](https://mysteadii.xyz). The landing-page hero video walks through three flows: email triage, chat → calendar, and proactive conflict detection.
...
If you find a security issue, please report it privately to [hello@mysteadii.xyz](mailto:hello@mysteadii.xyz) instead of opening a public issue.

## Contact

- **Web**: [mysteadii.xyz](https://mysteadii.xyz)
- **Email**: [hello@mysteadii.xyz](mailto:hello@mysteadii.xyz)
- **Request α access**: [mysteadii.xyz/request-access](https://mysteadii.xyz/request-access)
...
[mysteadii.xyz](https://mysteadii.xyz) にて公開中。トップページの動画で、3 つのフロー (受信箱分類・チャット → カレンダー・先回り衝突検知) を 30 秒で見られます。
...
セキュリティ問題を発見した場合は、公開 issue ではなく [hello@mysteadii.xyz](mailto:hello@mysteadii.xyz) まで非公開でご連絡ください。

## 連絡先

- **Web**: [mysteadii.xyz](https://mysteadii.xyz)
- **Email**: [hello@mysteadii.xyz](mailto:hello@mysteadii.xyz)
- **α アクセスをリクエスト**: [mysteadii.xyz/request-access](https://mysteadii.xyz/request-access)
