...
export const ja: Messages = {
  ...
  landing: {
    ...
    hero_animation: {
      ...
      card_action_mark_reviewed: "完了にする",
  ...
  onboarding: {
    step1: {
      ...
      why_calendar_gmail:
        "Calendar の読み書きと、Gmail の読み取り・修正・送信が可能になります。エージェントが受信メールをトリアージし、確認用に返信案を準備します。あなたの承認と undo 猶予（デフォルト 10 秒・変更可能）を経ないと送信は行われません。許可はいつでも Google アカウントから取り消せます。",
      why_notion:
  ...
  chats_list: {
    ...
    search_aria: "タイトルでチャットを検索",
    no_search_results: "一致するチャットはありません。",
    group_today: "今日",
    group_yesterday: "昨日",
    group_week: "今週",
    group_earlier: "それ以前",
  ...
  agent: {
    draft_actions: {
      ...
      toast_dismissed: "見送りました",
      toast_dismiss_failed: "見送りに失敗しました",
    ...
    next_action_banner: {
      ...
      archive_body:
        "Steadii はアーカイブを推奨しています。対応が済んだら見送ってください。",
      snooze_title: "Steadii は後で見直すことを提案しています。",
      snooze_body: "今は見送り、関連が出てきたら再表示されます。",
      no_op_title: "アクションは提案されていません。",
      no_op_body:
        "Steadii は対応が必要な内容を見つけませんでした。見送って片付けてください。",
      notify_only_title: "重要 — 返信不要。",
      notify_only_body:
        "見逃さないように Steadii が目印を付けました。確認して見送ってください。",
  ...
  app_layout: {
    ...
    recent_view_all: "すべて",
    recent_view_all_aria: "すべてのチャットを表示",
    recent_empty: "チャットはまだありません。ホームから始められます。",
    untitled: "無題",
  ...
  agent_rules_section: {
    ...
    feedback_empty:
      "フィードバックはまだ記録されていません。送信・編集・見送るたびに、ここに記録されて分類器がその送信者の傾向を学習します。",
  ...
  chat: {
    ...
    draft_actions: {
      ...
      confirm_subject: "件名",
      confirm_body: "本文",
      confirm_send_button: "送信する",
      sent_success: "✓ {time} に送信しました",
      sent_error: "送信に失敗しました — もう一度お試しください",
      send_aria: "{recipient} に下書きを送信",
      edit_aria: "下書きの本文を編集",
      edit_textarea_label: "下書き本文",
      looks_like_draft_tooltip: "下書きですか? 送信または編集できます。",
      missing_reply_target:
        "返信元のメールが見つかりません。受信トレイから開き直すと送信できます。",
    },
  },
  voice: {
  ...
  settings: {
    ...
    beta_features: {
      section_title: "ベータ機能",
      description:
        "実験中の機能です。デフォルトはオフ — 次世代の推論を試したい場合にオンにしてください。1 通あたりのコストが上がり、まだ粗い部分があります。",
      agentic_l2_label: "Agentic L2 — LLM 主導のツール使用型メール推論",
      agentic_l2_hint:
        "高リスクのメールに対して、カレンダーを確認し、送信者のタイムゾーンを推測し、必要に応じて確認質問を生成してから下書きを作成します。単発推論の約 3 倍のコスト。あなたのアカウントだけに適用されます。",
      on: "オン — オフにする",
      off: "オフ — オンにする",
    },
    queue_ux: {
      ...
      hide_read_hint:
        "オンにすると、Gmail で本文を読んでから少しの間で「気づき」カードが消えます。オフにすると、Steadii で見送るまで残ります。",
      on: "オン — オフにする",
      off: "オフ — オンにする",
    },
    profile_completion: {
  ...
  queue: {
    ...
    toast_undo: "取り消し",
    toast_send_cancelled: "送信を取り消しました",
    toast_send_failed: "送信できませんでした。もう一度お試しください。",
    pre_send_warning: {
      title: "送信前にご確認ください",
      body: "元のメールでは裏付けられない内容が下書きに含まれている可能性があります。",
      review: "確認する",
      send_anyway: "このまま送信",
      cancel: "キャンセル",
    },
    ...
    card_g: {
      proposal_header_mutual: "Steadii がこの予定を提案しています",
      proposal_header_deadline: "Steadii がこの締切を提案しています",
      add_to_calendar: "カレンダーに追加",
      edit: "編集",
      dismiss: "破棄",
      update_and_add: "更新して追加",
      cancel_edit: "キャンセル",
      expires_in_days: "{days}日後に自動破棄",
      editor_date_label: "日付",
      editor_start_time_label: "開始時刻",
      editor_duration_label: "所要時間(分)",
      editor_title_label: "タイトル",
      editor_validation_end_before_start: "終了時刻は開始より後にしてください。",
      editor_validation_past_date_warning: "過去の日付が選択されています。",
  ...
  proposal_detail: {
    ...
    already_status_dismissed: "この提案はすでに見送られています",
  ...
  connections_page: {
    ...
    regenerate_drafts: {
      ...
      help:
        "キューに残っている下書きすべてに対して、最新の分類ロジックと現在の言語設定で L2 推論と下書き本文を再実行します。送信済み・見送り済み・低リスクの行は自動でスキップされます。通常の L2 クレジットを消費します。",
  ...
  activity_log_page: {
    ...
    stat_drafts_sub:
      "{sent} 送信済み（うち自動 {auto}）・{dismissed} 見送り",
    ...
    cost_heading: "コストと使用量",
    cost_description:
      "あなたのために実行された全 LLM 呼び出しのトークン使用量です。当日 / 7 日 / 30 日のローリングウィンドウ。データソース: usage_events。",
    cost_stat_today: "本日",
    cost_stat_week: "今週",
    cost_stat_month: "今月",
    cost_by_task_heading: "タスク種別ごと（30 日間）",
    cost_calls_label: "{calls} 回",
    cost_top_runs_heading: "コストの大きな上位 {count} 件（30 日間）",
    cost_in_label: "入力",
    cost_out_label: "出力",
    cost_chat_link: "チャット",
    cost_per_user_heading: "ユーザー別（管理者 · 30 日間）",
  },
  settings_user_facts: {
    settings_back: "設定",
