...
export function buildAccessApprovedEmail(
  ...
  const text = [
    ...
    input.inviteUrl,
    "",
    "上のリンクから 3 ヶ月間、Pro 機能を無料でご利用いただけます。",
    "3 ヶ月後は通常料金へ自動切替。Settings からいつでも解約できます。",
    "",
    ...
    input.inviteUrl,
    "",
    "The link gives you 3 months of Pro for free. After that the",
    "standard rate applies — cancel anytime from Settings. Reply to",
    "this email if anything goes sideways.",
    "",
    "Thanks,",
    "— Ryuto",
  ].join("\n");
