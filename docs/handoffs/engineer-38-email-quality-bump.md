...
- Three structural gaps cause most of the variance:
  ...
  2. **No cold-start voice anchor** — for first-time senders, the model has no idea Ryuto is a a Pacific-TZ high-school student writing bilingual EN/JA in a particular register. Drafts default to generic LLM tone.
